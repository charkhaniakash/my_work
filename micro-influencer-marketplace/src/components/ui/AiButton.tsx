...
export default function AiButton({ onClick, saving = false, label = 'Generate Campaign with AI' }: AiButtonProps) {
    return (
        <div className="flex justify-end mb-4">
            <button
                ...
                onClick={onClick}
                disabled={saving}
                className={`relative rounded-md px-6 py-3 text-sm font-semibold text-white cursor-pointer shadow-sm 
